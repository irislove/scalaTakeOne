...
object Huffman {
  ...
  //    def times(chars: List[Char]): List[(Char, Int)] = {
  //    def resultsPair(char: Char, charsList: List[Char], resultList: List[(Char, Int)], countedList: List[Char]): List[(Char, Int)] = {
  //      if (charsList.tail.isEmpty && !countedList.isEmpty && countedList.contains(char)) resultList
  //      else if(charsList.tail.isEmpty && !countedList.isEmpty && !countedList.contains(char)) (charsList.head, charsList.count(Char => char == Char)) :: resultList
  //      else if (!countedList.isEmpty && countedList.contains(char)) resultsPair(charsList.tail.head, charsList.tail, resultList, countedList)
  //      else resultsPair(charsList.tail.head, charsList.tail, (charsList.head, charsList.count(Char => char == Char)) :: resultList, charsList.head :: countedList)
  //    }
  //    
  //    resultsPair(chars.head, chars, Nil, Nil)
  //  } 
